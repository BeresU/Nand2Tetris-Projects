// passed 
// start function: Sys.init, vars: 0
(Sys.Sys.init)
...
// start function: Sys.main, args: 0
...
// start function: Sys.main, vars: 5
(Sys.Sys.main)
...
// start function: Sys.add12, args: 1
...
// start function: Sys.add12, vars: 0
(Sys.Sys.add12)
